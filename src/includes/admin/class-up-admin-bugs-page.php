...
class Upstream_Bug_List extends WP_List_Table {
    ...
    public function get_views() {
        ...
        $views['all'] = "<a href='" . esc_url( $all_url ) . "' {$all_class} >" . __( 'All',
                'upstream' ) . "</a>({$all_count})";
        ...
        $views['mine'] = "<a href='" . esc_url( $mine_url ) . "' {$mine_class} >" . __( 'Mine',
                'upstream' ) . "</a>({$mine_count})";
                ...
                if ( ! empty( $status ) ) { ?>
                    ...
                    <select name='status' id='status' class='postform'>
                        ...
                        <?php foreach ( $status as $stati ) {
                            ...
                            ?>
                            <option
                                value="<?php echo $statusId; ?>" <?php isset( $_GET['status'] ) ? selected( $_GET['status'],
                                $statusTitle ) : ''; ?>><?php echo esc_html( $statusTitle ) ?></option>
                        <?php } ?>
                    </select>
                ...
                if ( ! empty( $severities ) ) { ?>
                    ...
                    <select name='severity' id='severity' class='postform'>
                        ...
                        <?php foreach ( $severities as $severity ) {
                            ...
                            ?>
                            <option
                                value="<?php echo $severityId; ?>" <?php isset( $_GET['severity'] ) ? selected( $_GET['severity'],
                                $severityTitle ) : ''; ?>><?php echo esc_html( $severityTitle ) ?></option>
                        <?php } ?>
                    </select>
