        ...
        <div class="media-body">
            <div class="o-comment__header">
                ...
                <?php if ( isset( $row->parent ) && $row->parent !== null ): ?>
                    <div
                        class="o-comment__replier"><?php printf( '%s <a href="#comment-%s" class="text-info" data-action="comment.go_to_reply">%s</a>',
                            __( 'In reply to', 'upstream' ), $row->parent->id,
                            $row->parent->created_by->name ); ?></div>
                <?php endif; ?>
