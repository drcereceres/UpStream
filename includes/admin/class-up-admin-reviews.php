    ...
    public function init() {
        ...
        if ( $this->found_five_projects() ) {
            $params = [
                ...
                'notice_text'  => __( 'Hey, I noticed you have created 5 or more projects on %sUpStream%s - that\'s awesome! May I ask you to give it a %s5-star%s rating on WordPress? Just to help us spread the word and boost our motivation.',
                    'upstream' ),
            ];
