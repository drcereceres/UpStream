...
function upstream_render_labels_field_callback( $field, $value, $object_id, $object_type, $field_type ) {
    ...
    ?>
    <div class="alignleft"><p><label for="<?php echo $field_type->_id( '_single' ); ?>'"><?php _e( 'Single',
                    'upstream' ); ?></label></p>
    ...
    <div class="alignleft"><p><label for="<?php echo $field_type->_id( '_plural' ); ?>'"><?php _e( 'Plural',
                    'upstream' ); ?></label></p>
        <?php echo $field_type->input( [
